...
#   We do QualityControl (QC), normalization, scalling, GFP selection and then this result will be aligned 
#   with the barcode sequences (alleles) dataframe to conduct our study

#         >>>>>>>> IMPORTANT: the seurat objects in Data/ in this GitHub repository are already filtered.
#                             Depending on the experiment, we applied different filters. 
#                             Do no hesitate to contact fot further information 🚀 📧 😃
